"""
Django settings for crystalscakes project.
...
ALLOWED_HOSTS = ['crystals-cakes-4efc6d8bc1c9.herokuapp.com' , 'localhost', '127.0.0.1']
...
ROOT_URLCONF = 'crystalscakes.urls'
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'crystals-cakes'
...
if 'DEVELOPMENT' in os.environ:
    EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'
    DEFAULT_FROM_EMAIL = 'crystalscakes@example.com'
else:
